...
//               className="bg-yellow-500 hover:bg-yellow-600 text-white font-bold px-10 py-3 rounded-full text-lg shadow-md transition duration-300"
//             >
...
//             <div>
//               <p><strong>Commodity:</strong> {searchResult.commodityName}</p>
